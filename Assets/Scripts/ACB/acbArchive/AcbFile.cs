...
namespace DereTore.Exchange.Archive.ACB {
    public sealed partial class AcbFile : UtfTable {
        ...
        public static AcbFile FromStream(MemoryStream stream, string fileName, bool disposeStream) {
            return FromStream(stream, fileName, 0, stream.Length, disposeStream);
        }
        ...
        public static AcbFile FromStream(MemoryStream stream, string fileName, long offset, long size, bool disposeStream) {
            return new AcbFile(stream, offset, size, fileName, disposeStream);
        }
